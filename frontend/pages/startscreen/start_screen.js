...
function startScreen(){
    ...
    previousPlayers.forEach(player => {
        ...
        playerDiv.className = 'flex row';
        playerDiv.style.alignItems = "center";
        playerDiv.innerHTML = `
            <span class="delete-button trash" data-username="${player}" style="cursor: pointer;">${Icons.trash}</span>
            <div class="username-container flex row">
